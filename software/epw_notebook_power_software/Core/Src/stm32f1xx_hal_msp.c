...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, VCC12V_SYS_VADC_Pin|VCC12V_SB_VADC_Pin|VCC19V5_VADC_Pin|VCC19V5_IADC_Pin
                          |T_BOOST_Pin|T_REAR_Pin|T_FRONT_Pin);

    HAL_GPIO_DeInit(GPIOB, VCC5V0_SYS_VADC_Pin|VCC3V3_SYS_VADC_Pin);
